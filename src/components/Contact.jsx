...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    setLoading(true);
    emailjs.send('service_lilo3zr','template_w4aarur', {from_name:form.name, to_name:'Rudra', from_email:form.email,to_email:'rudra619kumar@gmail.com',message:form.message},'iVe3KTYHvtE4dZ3BT').then(()=>{
      setLoading(false);
  ...
  return (
    <div className='xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden'>
      ...
      <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col gap-8'>
        ...
        <button type='submit' className='bg-tertiary py-3 px-8 w-fit shadow-md rounded-xl outline-none text-white font-bold shadow-primary '>
